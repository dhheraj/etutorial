...
const Profile = () => {
  ...
  const handleEditUsername =
    () => {
      ...
      // const editUsername=firestore.collection('userlogin').where('userId','==',userId).set()
        ...
        <div className="mt-6 border-t border-gray-100">
          <dl className="divide-y divide-gray-100">
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 flex">@ username &nbsp;<button onClick={handleEditUsername} className='p-1.5 hover:rounded-lg bg-gray-100' ><VscEdit size={16} /></button></dd>
            </div>
